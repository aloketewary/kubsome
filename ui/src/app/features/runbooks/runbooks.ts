...
export class RunbooksComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get<any>('/api/playbooks').subscribe({ next: (res) => {
      ...
      const colors: Record<string, string> = { CrashLoopBackOff: '#f43f5e', ImagePullBackOff: '#f97316', OOMKilled: '#f43f5e', Pending: '#f59e0b', FailedScheduling: '#f59e0b', Unhealthy: '#f43f5e', restart_spike: '#f97316', event_storm: '#8b5cf6', DNS: '#10b981', NetworkPolicy: '#10b981', HPA: '#00d4ff', Security: '#f43f5e', ResourceExhaustion: '#8b5cf6', RolloutStuck: '#00d4ff', HighLatency: '#f59e0b', CertificateExpiry: '#f97316', PVCPending: '#f59e0b', NodeNotReady: '#f43f5e', ServiceUnavailable: '#f43f5e', ConfigMapChange: '#00d4ff', HighRestarts: '#f97316', IngressNotWorking: '#f59e0b', JobFailing: '#8b5cf6', EtcdSlow: '#f43f5e', GracefulShutdown: '#f59e0b', RBAC: '#00d4ff' };
