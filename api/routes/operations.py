...
def get_node_ops():
    ...
    # Bolt: optimize node-ops endpoint by eliminating N+1 bottleneck
    # Fetches all nodes and all pods in parallel, then aggregates in-memory
    ...
    # Create a mapping of node name to pod count
    pod_counts = {}
